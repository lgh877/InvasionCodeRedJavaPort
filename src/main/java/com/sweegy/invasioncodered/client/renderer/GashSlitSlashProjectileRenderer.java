...
public class GashSlitSlashProjectileRenderer extends EntityRenderer<GashSlitSlashProjectileEntity> {
	...
	public GashSlitSlashProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelgashslit_slash(context.bakeLayer(Modelgashslit_slash.LAYER_LOCATION));
	}

	@Override
	public void render(GashSlitSlashProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(GashSlitSlashProjectileEntity entity) {
		return texture;
	}
}